                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ asset('logos/' . $job['company_logo']) }}" class="h-12 w-auto block mx-auto" alt="{{ $job['company_name'] }}">
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                            ...
                                            <span class="inline-block bg-gray-200 rounded-full px-2 py-0.5 text-xs font-medium text-gray-700">{{ $skill['skill'] }}</span>
                                            @endforeach
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                            @foreach ($job['extras'] as $extra)
                                            <span class="inline-block bg-amber-100 rounded-full px-2 py-0.5 text-xs font-medium text-amber-800">{{ $extra['extra'] }}</span>
                                            @endforeach
                                        </div>
                                    </td>
